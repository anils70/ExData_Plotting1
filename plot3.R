...
subMetering1 <- as.numeric(subPowerDataSet$Sub_metering_1) 
subMetering2 <- as.numeric(subPowerDataSet$Sub_metering_2) 
subMetering3 <- as.numeric(subPowerDataSet$Sub_metering_3) 
